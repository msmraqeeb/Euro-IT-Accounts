      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-xl shadow-slate-200/50 rounded-2xl sm:px-10 border border-slate-100">
          ...
          <div className="mt-6">
            ...
            <div className="mt-4 grid grid-cols-1 gap-2 text-xs text-slate-500 bg-slate-50 p-4 rounded-lg">
               <div className="flex justify-between">
                 <span>Admin:</span>
                 <span className="font-mono">admin@email.com / 123456</span>
               </div>
               <div className="flex justify-between">
                 <span>Viewer:</span>
                 <span className="font-mono">viewer@email.com / 123456</span>
               </div>
            </div>
          </div>
        </div>
